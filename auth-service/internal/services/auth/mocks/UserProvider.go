...
import (
	models "auth-service/internal/domens/models"
	context "context"
...
// IsAdmin provides a mock function with given fields: ctx, uid
func (_m *UserProvider) IsAdmin(ctx context.Context, uid int64) (bool, error) {
